...
if (
  ...
  $lp_name = isset($_POST['lp_name']) ? sanitize_text_field(wp_unslash($_POST['lp_name'])) : '';
  ...
  } elseif ($lp_name === '' || !is_email($lp_email)) {
    $lp_form_status = 'error';
    $lp_form_message = 'Bitte geben Sie Ihren Namen und eine gültige E-Mail Adresse ein.';
  } else {
  ...
  <section id="formular" class="lp-cta-section">
    ...
    <div class="lp-cta-card">
      ...
      <form class="lp-cta-form" action="<?php echo esc_url(get_permalink()); ?>#formular" method="post">
        ...
        <input class="lp-cta-input" type="text" name="lp_name" placeholder="Vorname Nachname*" value="<?php echo isset($lp_name) && $lp_form_status !== 'success' ? esc_attr($lp_name) : ''; ?>" required>
        <input class="lp-cta-input" type="email" name="lp_email" placeholder="E-Mail Adresse*" value="<?php echo isset($lp_email) && $lp_form_status !== 'success' ? esc_attr($lp_email) : ''; ?>" required>
