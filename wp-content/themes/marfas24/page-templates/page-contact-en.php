<?php
/**
 * Template Name: Contact (Fix) EN
 */

// Meta description only for this template
add_action('wp_head', function () {
  if (!is_page_template('pagecontacten.php')) return; // <-- имя файла шаблона проверь

  $desc = 'Contact the practice of Prof. DDr. Martin Faschingbauer in Vienna (1090): office hours, address, phone and email. Appointments by arrangement.';
  ...
  <section class="kontakt-hero">
    <div class="kontakt-container">
      ...
      <h1 class="svc-hero__title">
        <span class="svc-hero__title-main">Book an appointment</span>
        <span class="svc-hero__title-sub">at my practice.</span>
      </h1>
      ...
      <div class="kontakt-grid">
        ...
        <div class="kontakt-side">
          ...
          <aside class="kontakt-card">
            <div class="kontakt-card__title">Office Hours</div>
            <div class="kontakt-card__text">
              <div class="kontakt-hours">
                ...
                <div class="kontakt-hours__note">and by appointment</div>
          ...
          <aside class="kontakt-card">
            ...
            <div class="kontakt-card__text">
              ...
              <?php if ($map_link) : ?>
                <br><a target="_blank" rel="noopener" href="<?php echo esc_url($map_link); ?>">View on Google Maps</a>
              <?php endif; ?>
        ...
        <div class="kontakt-map">
          ...
          <?php else : ?>
            <div class="kontakt-map__placeholder">Map</div>
          <?php endif; ?>
        </div>
  ...
  <section class="kontakt-bottom">
    <div class="kontakt-container">
      <img class="kontakt-bottom__img"
           ...
           alt="Dr. Martin Faschingbauer – artificial hip joint"
           loading="lazy">
    </div>
  </section>
