...
add_action('plugins_loaded', function () {
    ...
    $modules = [
        ...
        'endoprothetik' => 'modules/endoprothetik.php',
        'orthopaede_wien' => 'modules/orthopaede-wien.php',
        'uebermich'     => 'modules/ueber-mich.php',
        'kooperationen' => 'modules/kooperationen.php',
